...
//---------------------------------------------------
  ...
  if(isAlternativeCaseFileItem(element)){
    ...
    if(notHasAltertiveCaseFileItem(element) && element.businessObject.definitionRef.chainValue < 3){
      assign(actions, {
          'append.alternative-case-file-item': {
              group: 'model',
              className: 'cmmn-icon-alternative-case-file-item',
  ...
  if(isAlternativeMilestone(element)){
    ...
    if(notHasAltertiveMilestone(element) && element.businessObject.definitionRef.chainValue < 3){
